...
(function() {
	gauges.createDc = createDc;
	gauges.createMotor = createMotor;
	gauges.createTemperature = createTemperature;
	...
	*/
	...
	function createTemperature(config) {
